...
const characters: Character[] = [
  ...
  },
  {
    ...
    title: '镜花谋士',
    className: '幻阵术师',
    image: '/characters/chen-yuanyuan.png',
    rarity: 'UR',
    quote: '繁华只是一瞬，阵眼才是永恒。',
    accent: '#f3bd5c',
    rgb: '243, 189, 92',
  ...
  },
  {
    ...
    title: '霜刃御前',
    className: '高速剑豪',
    image: '/characters/yagyu-yukihime.png',
    rarity: 'SSR',
    quote: '雪落之前，斩击已经抵达。',
    accent: '#8ce9ff',
    rgb: '140, 233, 255',
  ...
  },
  {
    ...
    title: '绮羽圣裔',
    className: '辉光祭司',
    image: '/characters/peacock-princess.png',
    rarity: 'SSR',
    quote: '万羽展开时，败局也会回光。',
    accent: '#2fe6a6',
    rgb: '47, 230, 166',
  ...
  },
  {
    ...
    title: '烬火祷师',
    className: '秘火吟诵者',
    image: '/characters/hosokawa-garasha.png',
    rarity: 'SR',
    quote: '火不是毁灭，是另一种祈祷。',
    accent: '#ff9d3d',
    rgb: '255, 157, 61',
  ...
  },
  {
    ...
    title: '北境骁骑',
    className: '先锋统帅',
    image: '/characters/hua-mulan.png',
    rarity: 'UR',
    quote: '长风过境，铁骑先行。',
    accent: '#ff515f',
    rgb: '255, 81, 95',
  ...
  },
  {
    ...
    title: '墨月歌姬',
    className: '咒歌使',
    image: '/characters/ono-no-komachi.png',
    rarity: 'SSR',
    quote: '一首短歌，足以让月色改道。',
    accent: '#bd8cff',
    rgb: '189, 140, 255',
  ...
  },
  {
    ...
    title: '幻卷秘史',
    className: '编年术士',
    image: '/characters/murasaki-shikibu.png',
    rarity: 'UR',
    quote: '被写下的命运，也可以被改写。',
    accent: '#a98bff',
    rgb: '169, 139, 255',
